...
while true; do
    ...
    git clone https://github.com/toolchains-compile/arm-eabi-gcc.git armeabi
		echo -e ""
	...
	if [ "$choice" == "4" ]; then
		...
		git clone -b lav https://github.com/iamsaalim/AnyKernel3
