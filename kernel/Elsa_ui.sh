#!/usr/bin/env bash
# Copyright (C) 2018 iamsaalim (iamsaalim)
...
CONFIG=elsa_global_h990_defconfig
CORES=$(grep -c ^processor /proc/cpuinfo)
THREAD="-j$CORES"
CROSS_COMPILE+="ccache "
CROSS_COMPILE+="$PWD/aarch64-linaro-linux-android/bin/aarch64-linaro-linux-android-"
...
while true; do
	...
	if [ "$choice" == "1" ]; then
		...
		git clone https://github.com/toolchains-compile/aarch64-linaro-linux-android
		echo -e ""
